...
function App() {
  ...
  return (
    <main className="flex justify-center min-h-screen lg:items-center bg-mangolia">
      ...
      <div className="relative flex flex-col items-center justify-between w-full lg:hidden">
        ...
        <div className={`${activeStep > 4 ? 'hidden' : 'block'} fixed bottom-0 w-full bg-white p-[20px] z-50 shadow-[0_1px_10px_rgba(0,0,0,0.1)]`}>
          <StepButtons />
        </div>
      </div>
    </main>
