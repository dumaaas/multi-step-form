      ...
      <div className="rounded-[8px] px-[15px] lg:px-[30px] py-[15px] lg:py-[20px] bg-[rgba(150,153,171,0.1)]">
        ...
        >
          <div className="">
            ...
            <p
              onClick={() => changePlan()}
              className="underline transition-colors duration-150 ease-in-out cursor-pointer text-cool-gray hover:text-marine-blue lg:text-[16px] text-[14px]"
            >
              Change
            </p>
          </div>
                ...
                return (
                  <div className="flex items-center justify-between flex-1 pt-[15px] lg:text-[16px] text-[14px] lg:pt-[20px]">
                    ...
                    <p className="text-[14px] lg:text-[16px] text-marine-blue">
                      +${!isMonthly ? obj.monthlyPrice : obj.yearlyPrice}/
                      {!isMonthly ? "mo" : "yr"}
                    </p>
                  </div>
                );
